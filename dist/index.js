...
Object.defineProperty(exports, "__esModule", { value: true });
// action types
exports.ADD_PRODUCT_UNIT_TO_ORDERS = "ADD_PRODUCT_TO_ORDERS";
exports.REMOVE_PRODUCT_UNIT_FROM_ORDERS = "REMOVE_PRODUCT_UNIT_FROM_ORDERS";
exports.REMOVE_PRODUCT_FROM_ORDERS = "REMOVE_PRODUCT_FROM_ORDERS";
exports.CLEAR_ORDERS = "CLEAR_ORDERS";
// action creators
function addProductUnitToOrders(productId) {
    return {
        type: exports.ADD_PRODUCT_UNIT_TO_ORDERS,
        payload: {
            productId: productId
        }
    };
}
exports.addProductUnitToOrders = addProductUnitToOrders;
function removeProductUnitFromOrders(productId) {
    return {
        type: exports.REMOVE_PRODUCT_UNIT_FROM_ORDERS,
        payload: {
            productId: productId
        }
    };
}
exports.removeProductUnitFromOrders = removeProductUnitFromOrders;
function removeProductFromOrders(productId) {
    return {
        type: exports.REMOVE_PRODUCT_FROM_ORDERS,
        payload: {
            productId: productId
        }
    };
...
const orderstatus_1 = __importDefault(__webpack_require__(/*! ./containers/orderstatus */ "./src/app/containers/orderstatus.ts"));
const orderlist_1 = __importDefault(__webpack_require__(/*! ./containers/orderlist */ "./src/app/containers/orderlist.ts"));
const productlist_1 = __importDefault(__webpack_require__(/*! ./containers/productlist */ "./src/app/containers/productlist.ts"));
class AppComponent extends React.Component {
    render() {
        return (React.createElement("div", { className: "appComponent" },
            React.createElement(orderstatus_1.default, null),
...
/***/ "./src/app/components/orderitem.tsx":
/*!******************************************!*\
  !*** ./src/app/components/orderitem.tsx ***!
  \******************************************/
/*! no static exports found */
...
class OrderItem extends React.Component {
    render() {
        return (React.createElement("div", { className: "orderItem" },
            React.createElement("label", null, "Product:"),
            React.createElement("label", null, this.props.name),
            React.createElement("label", null, "Count:"),
            React.createElement("label", null, this.props.count),
            React.createElement("button", { onClick: this.props.addProductUnitToOrders.bind(this) }, "Add Unit"),
            React.createElement("button", { onClick: this.props.removeProductUnitFromOrders.bind(this) }, "Remove Unit"),
            React.createElement("button", { onClick: this.props.removeProductFromOrders.bind(this) }, "Remove Product")));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const orderitem_1 = __importDefault(__webpack_require__(/*! ../containers/orderitem */ "./src/app/containers/orderitem.ts"));
class OrderList extends React.Component {
    render() {
        return (React.createElement("div", { className: "orderList" },
            React.createElement("button", { onClick: this.props.clearAllOrders.bind(this) }, "Clear All Orders"),
            React.createElement("label", null, "Orders:"),
            React.createElement("br", null),
            this.props.orders.map((order) => {
                return (React.createElement(orderitem_1.default, { key: order.productId, productId: order.productId, count: order.count }));
            })));
    }
}
...
/***/ "./src/app/components/orderstatus.tsx":
/*!********************************************!*\
  !*** ./src/app/components/orderstatus.tsx ***!
  \********************************************/
/*! no static exports found */
...
class OrderStatus extends React.Component {
    render() {
        return (React.createElement("div", { className: "orderStatus" },
            React.createElement("label", null, "Total Orders Price:"),
            React.createElement("label", null,
                this.props.totalOrdersPrice,
                "$")));
    }
}
...
class ProductItem extends React.Component {
    render() {
        return (React.createElement("div", { className: "productItem" },
            React.createElement("label", null, "Name:"),
            React.createElement("label", null, this.props.name),
            React.createElement("label", null, "Price:"),
            React.createElement("label", null, this.props.price),
            React.createElement("button", { onClick: this.props.addProductUnitToOrders.bind(this), disabled: this.props.isOrdered() }, "Add Product To Orders")));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const productitem_1 = __importDefault(__webpack_require__(/*! ../containers/productitem */ "./src/app/containers/productitem.ts"));
class ProductList extends React.Component {
    render() {
        return (React.createElement("div", { className: "productList" },
            React.createElement("label", null, "Products:"),
            React.createElement("br", null),
            this.props.products.map((product) => {
                return (React.createElement(productitem_1.default, { key: product.id, id: product.id, name: product.name, price: product.price }));
            })));
    }
}
...
/***/ "./src/app/containers/orderitem.ts":
/*!*****************************************!*\
  !*** ./src/app/containers/orderitem.ts ***!
  \*****************************************/
/*! no static exports found */
...
const orderitem_1 = __importDefault(__webpack_require__(/*! ../components/orderitem */ "./src/app/components/orderitem.tsx"));
const actions_1 = __webpack_require__(/*! ../actions/actions */ "./src/app/actions/actions.ts");
const mapDispatchToProps = (dispatch, props) => {
    const processProductInOrders = (actionCreator) => {
        dispatch(actionCreator(props.productId));
    };
    return {
        addProductUnitToOrders: () => {
            processProductInOrders(actions_1.addProductUnitToOrders);
        },
        removeProductUnitFromOrders: () => {
            processProductInOrders(actions_1.removeProductUnitFromOrders);
        },
        removeProductFromOrders: () => {
            processProductInOrders(actions_1.removeProductFromOrders);
        }
    };
};
const mapStateToProps = (state, props) => {
    const productName = () => {
        ...
        const product = filteredProducts.pop();
        if (!product) {
            return "";
        }
        return product.name;
...
const OrderItemContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(orderitem_1.default);
exports.default = OrderItemContainer;


/***/ }),

/***/ "./src/app/containers/orderlist.ts":
/*!*****************************************!*\
  !*** ./src/app/containers/orderlist.ts ***!
  \*****************************************/
/*! no static exports found */
...
const actions_1 = __webpack_require__(/*! ../actions/actions */ "./src/app/actions/actions.ts");
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const orderlist_1 = __importDefault(__webpack_require__(/*! ../components/orderlist */ "./src/app/components/orderlist.tsx"));
...
const mapDispatchToProps = (dispatch) => {
    return {
        clearAllOrders: () => {
            dispatch(actions_1.clearOrders());
        }
    };
};
const OrderListContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(orderlist_1.default);
exports.default = OrderListContainer;


/***/ }),

/***/ "./src/app/containers/orderstatus.ts":
/*!*******************************************!*\
  !*** ./src/app/containers/orderstatus.ts ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const orderstatus_1 = __importDefault(__webpack_require__(/*! ../components/orderstatus */ "./src/app/components/orderstatus.tsx"));
const mapStateToProps = (state) => {
    const totalOrdersPriceSum = state.orders
        .reduce((previousSum, currentOrder) => {
        const productsFromOrder = state.products
            .filter((product) => {
        ...
        const product = productsFromOrder.pop();
        if (!product) {
            return previousSum;
        }
...
const OrderStatusContainer = react_redux_1.connect(mapStateToProps)(orderstatus_1.default);
exports.default = OrderStatusContainer;


/***/ }),

/***/ "./src/app/containers/productitem.ts":
/*!*******************************************!*\
  !*** ./src/app/containers/productitem.ts ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const productitem_1 = __importDefault(__webpack_require__(/*! ../components/productitem */ "./src/app/components/productitem.tsx"));
const actions_1 = __webpack_require__(/*! ../actions/actions */ "./src/app/actions/actions.ts");
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const mapStateToProps = (state, props) => {
    const productIsOrdered = () => {
        const productInOrders = state.orders
            .filter((order) => {
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        addProductUnitToOrders: () => {
            dispatch(actions_1.addProductUnitToOrders(props.id));
        }
    };
};
const ProductItemContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(productitem_1.default);
exports.default = ProductItemContainer;


/***/ }),

/***/ "./src/app/containers/productlist.ts":
/*!*******************************************!*\
  !*** ./src/app/containers/productlist.ts ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const productlist_1 = __webpack_require__(/*! ../components/productlist */ "./src/app/components/productlist.tsx");
const mapStateToProps = (state) => {
    return {
        products: state.products
    };
};
const ProductListContainer = react_redux_1.connect(mapStateToProps)(productlist_1.ProductList);
...
function addProductUnitToOrders(state, action) {
    if (!action.payload) {
        return state;
    }
    const productIsOrdered = state.orders
        .filter((order) => {
...
function addNewProductUnitToOrders(state, action) {
    if (!action.payload) {
        return state;
    }
    const ordersWithNewProduct = [
        ...state.orders,
        {
...
function updateProductCountInOrders(state, action) {
    if (!action.payload) {
        return state;
    }
    const ordersWithIncreasedProductCount = state.orders
        .map((order) => {
        if (order.productId !== action.payload.productId) {
            return order;
        }
...
function removeProductUnitFromOrders(state, action) {
    if (!action.payload) {
        return state;
    }
    const ordersWithRemovedProductUnit = state.orders.map((order) => {
...
function removeProductFromOrders(state, action) {
    if (!action.payload) {
        return state;
    }
    const ordersWithRemovedProduct = state.orders
        .filter((order) => {
        if (order.productId !== action.payload.productId) {
            return true;
        }
...
function clearOrders(state, action) {
    // remove all orders
    return Object.assign({}, state, {
        orders: []
    });
}
function processProductInOrders(state, action) {
    const actionToProcessProduct = action;
    if (!actionToProcessProduct) {
        return state;
    }
    switch (actionToProcessProduct.type) {
        case actions_1.ADD_PRODUCT_UNIT_TO_ORDERS:
            return addProductUnitToOrders(state, actionToProcessProduct);
        case actions_1.REMOVE_PRODUCT_UNIT_FROM_ORDERS:
            return removeProductUnitFromOrders(state, actionToProcessProduct);
        case actions_1.REMOVE_PRODUCT_FROM_ORDERS:
            return removeProductFromOrders(state, actionToProcessProduct);
        default:
            return state;
    }
}
function processOrders(state = initialState, action) {
...
exports.appStoreReducer = processOrders;
...
const reducers_1 = __webpack_require__(/*! ../reducers/reducers */ "./src/app/reducers/reducers.ts");
const initialState = {
    products: [
        {
            id: 1,
...
exports.appStore = redux_1.createStore(reducers_1.appStoreReducer, initialState);
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const store_1 = __webpack_require__(/*! ./app/store/store */ "./src/app/store/store.ts");
const app_1 = __importDefault(__webpack_require__(/*! ./app/app */ "./src/app/app.tsx"));
